...
<head>
    ...
    <!-- Title -->
    <title>News and Updates - instafinance</title>
        ...
        <div class="container">
            ...
            @foreach($articles as $article)
                ...
                <div class="col-12 col-lg-6 col-sm-6">
                        ...
                        <img src="{{asset('attatchments_loans/'.$article->cover_page)}}" class="imagen__curso" width="500" height="500">
         ...
         <!-- Body and Title -->
 <h5 style="color:royalblue">{{$article->title}}</h5>
 <hr>
               <p style="font-style:italic; color:gray; font-size:12px;"> Posted By: {{$article->created_by}} </p>
               <p style="font-style:italic; color:gray; font-size:12px;">posted on: about {{$article->created_at->diffForHumans()}} </p>            

 
 
 <!--show body contents here now-->
 <p  id="readmore">{{ str_limit(($article->body), 10, '...' ) }}
 @if (strlen(($article->body)) > 10)
        <span onclick="showAll()" class="btn btn-info btn-sm">Read More</span>
       
        @endif
 </p>
 <span style="display:none;"  id="fullText">{{$article->body}}</span>
 <span style="font-size:14px" id="all"></span>
...
function showAll(){
   ...
   fulText = document.getElementById('fullText').innerHTML;  
   document.getElementById('all').innerHTML = fulText;  
