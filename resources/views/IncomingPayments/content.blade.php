<table class="table" id="incoming_payments">
  <thead>
    <tr>
      <th scope="col">No</th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#incoming_payments').DataTable({
        processing: true,
        serverSide: true,
        "lengthChange": false,
        scrollX: true,
        dom:'lBfrtip',
        ajax: "{{ route('all_incoming_payments') }}",
        columns: [
        ...
        title: 'Incoming Payments Report',
        exportOptions: {
            columns: ':visible'
        }
