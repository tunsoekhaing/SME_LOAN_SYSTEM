...
<h3>Revoke Roles From Users </h3>
<br>
<!-- Create form with Bootstrap styling -->
<div class="container">
  <form class="form-horizontal" action="{{route('roles_users.revoke')}}" method="post">
    @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="dropdown" class="col-sm-2 control-label">Revoke Role(s):</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-success" onclick="submitData()">Revoke</button>
      </div>
    </div>
  </form>
</div>
