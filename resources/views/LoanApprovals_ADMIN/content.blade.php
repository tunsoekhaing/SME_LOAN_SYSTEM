...
<div class="border p-3">
  <form method="POST" action="{{ route('approve_or_denie') }}">
    ...
    <table class="table table-bordered">
      ...
      <tr style="display: none;">
        ...
        <tr>
          <td>Are you approving this Loan (DLO)?</td>
          <td>
            <div class="form-check">
        ...
        <tr>
          <td>Loan Officers Comment (DLO) </td>
          <td colspan="2">
        ...
        <tr>
          <td>Are you approving this Loan (CFO)?</td>
          <td>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="cfo_decision" value="yes" id="cfo_decision"  @if($loan_status->cfo_decision == 1) checked @endif disabled>
              <label class="form-check-label" for="cfo_decision">Yes</label>
            </div>
          </td>
          <td>
            <div class="form-check">
            <input class="form-check-input" type="checkbox" name="cfo_decision" value="no" id="cfo_decision" @if($loan_status->cfo_decision == 4) checked @endif disabled>
              <label class="form-check-label" for="cfo_decision">No</label>
            </div>
          </td>
        </tr>
        <tr>
          <td>Chief Financial Officers Comment (CFO) </td>
          <td colspan="2">
            <div class="form-floating">
              <textarea class="form-control" name="cfo_comments" id="cfo_comments" rows="3" readonly>{{$loan_status->cfo_comments}}</textarea>
              
            </div>
          </td>
        </tr>
        <tr>
          <td><button class="btn btn-danger">Are you approving this Loan (ADMIN)?</button></td>
          <td>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="admin_decision" value="yes" id="admin_decision"  >
              <label class="form-check-label" for="admin_decision">Yes</label>
            </div>
          </td>
          <td>
            <div class="form-check">
            <input class="form-check-input" type="checkbox" name="admin_decision" value="no" id="admin_decision"  >
              <label class="form-check-label" for="admin_decision">No</label>
            </div>
          </td>
        </tr>
      </tbody>
